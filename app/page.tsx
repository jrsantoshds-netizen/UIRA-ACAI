...
const UiraRune = () => (
  <svg 
    ...
    className="h-[12vw] sm:h-16 md:h-20 lg:h-[6.5rem] w-auto drop-shadow-lg text-[#b8a0bf] shrink-0"
  >
    {/* U */}
    ...
    <main className="min-h-[100dvh] bg-[#1e0521] text-white overflow-x-hidden font-sans relative flex flex-col">
      ...
      <div className="relative z-10 max-w-xl mx-auto px-4 pb-40">
        ...
        >
          ...
          <h1 className="flex flex-row items-center justify-center gap-3 sm:gap-6 mb-6 mt-4 md:mt-2 drop-shadow-2xl hover:scale-105 transition-transform duration-500 hover:brightness-110 cursor-default w-full whitespace-nowrap">
            <UiraRune />
            <span className="w-[1.5px] h-12 sm:h-16 lg:h-24 bg-white/30 shrink-0"></span>
            <div className="flex flex-col text-left items-start shrink-0">
              <span className="font-bebas text-[7vw] sm:text-5xl md:text-[3.5rem] text-[#e0d6e6] leading-[0.85] tracking-[0.02em] hover:text-[#a3e635] transition-colors">
                AÇAÍ DA
              </span>
              <span className="font-bebas text-[7vw] sm:text-5xl md:text-[3.5rem] text-[#e0d6e6] leading-[0.85] tracking-[0.02em] hover:text-[#a3e635] transition-colors">
                AMAZÔNIA
        ...
        >
          ...
          <div className="relative w-full aspect-square md:aspect-[4/5] max-h-[500px] rounded-t-[32px] overflow-hidden z-10 border-x border-t border-[#4a0e4e]">
            <div className="absolute inset-0 z-0 flex flex-col items-center justify-center text-center p-6 bg-[#1e0521]">
              ...
              <p className="text-sm text-purple-300">
                ...
                <br />
                (Para testar, faça upload e renomeie para{" "}
                <span className="font-mono text-[#a3e635]">fundo.jpg</span>)
              </p>
            </div>
          ...
          <div className="w-full bg-gradient-to-b from-[#110113] to-[#1e0521] px-4 sm:px-8 py-5 sm:py-6 relative z-10 border-x border-[#4a0e4e]">
            <div className="flex flex-row justify-between items-end w-full gap-2 sm:gap-4">
              {/* Left Side: Price */}
              <div className="shrink-0">
                <div className="bg-[#4a0e4e] text-white text-[8px] sm:text-[10px] md:text-xs font-bold uppercase px-2 sm:px-3 py-1 sm:py-1.5 mb-2 sm:mb-3 w-max tracking-[0.2em] sm:tracking-[0.3em]">
                  Premium Quality
                </div>
                <div className="text-[14vw] sm:text-6xl md:text-7xl font-black text-[#a3e635] drop-shadow-2xl tracking-tighter flex items-start leading-none group cursor-default">
                  <span className="group-hover:scale-110 transition-transform origin-left">
                    R$ 20
                  </span>
                  <span className="text-[7vw] sm:text-4xl md:text-5xl leading-none mt-1 md:mt-2 group-hover:scale-110 transition-transform origin-left delay-75">
                    ,00
                  </span>
                </div>
              </div>
              ...
              {/* Right Side: Tags */}
              <div className="flex flex-col gap-2 sm:gap-3 items-end shrink-0">
                <span className="bg-[#0b0113] text-[8px] sm:text-[10px] md:text-xs uppercase font-bold tracking-[0.1em] sm:tracking-[0.2em] px-3 py-2 sm:px-4 sm:py-2.5 md:py-3 text-white border border-white/5 shadow-xl flex items-center gap-2 sm:gap-3 w-max">
                  <div className="rounded-full border border-[#a3e635] p-[1px] sm:p-0.5">
                    <CheckCircle2 className="w-2.5 h-2.5 sm:w-3 h-3 md:w-3.5 md:h-3.5 text-[#a3e635]" />
                  </div>
                  Orgânico
                </span>
                <span className="bg-[#0b0113] text-[8px] sm:text-[10px] md:text-xs uppercase font-bold tracking-[0.1em] sm:tracking-[0.2em] px-3 py-2 sm:px-4 sm:py-2.5 md:py-3 text-white border border-white/5 shadow-xl flex items-center gap-2 sm:gap-3 w-max">
        ...
        >
          <div className="flex items-center gap-4 pl-2">
            ...
            <div>
              <p className="text-[#a3e635] text-[10px] font-bold uppercase tracking-[0.2em] mb-1">
                Demanda Alta
              </p>
              <p className="text-purple-200 text-sm opacity-90 font-medium">
                O lote atual esgota em:
              </p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center space-x-6 justify-center mb-8 opacity-80">
            ...
            <span className="uppercase tracking-[0.3em] text-xs font-bold text-[#a3e635]">
              Falam do Nosso Açaí
            </span>
            <div className="h-px w-12 bg-[#a3e635]"></div>
          </div>
          ...
          <div className="bg-[#4a0e4e]/20 border border-[#a3e635]/30 rounded-tl-[40px] rounded-br-[40px] p-6 text-left relative shadow-lg">
            <div className="flex gap-1 mb-4">
              {[...Array(5)].map((_, i) => (
                <Star
                  key={i}
                  className="w-5 h-5 fill-[#a3e635] text-[#a3e635]"
                />
              ))}
            </div>
            <p className="text-purple-100 text-base italic mb-6">
